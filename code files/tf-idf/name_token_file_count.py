...
pickle_file = '../parseXML/curl_name_tokens.p' #had to change as it is in parseXML folder, previously '../../Data files/curl_name_tokens.p'
...
pickle.dump( token_file_count, open( "../../Data files/curl_token_file_count.p", "wb" ) )
