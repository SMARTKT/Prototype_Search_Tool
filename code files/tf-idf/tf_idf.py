...
pickle_file1 = "../../Data files/curl_symbol_file_token_count.p"
pickle_file2 = "../../Data files/curl_symbol_file_count.p"
...
pickle.dump( tf_idf, open( "../../Data files/curl_tf_idf_symbol.p", "wb" ) )
